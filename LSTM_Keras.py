...
def run_experiment(repeats=10):
    ...
    for r in range(repeats):
        ...
        with open("/content/drive/My Drive/Colab Notebooks/model/model.json", "w") as json_file:
            json_file.write(model_json)
        # serialize weights to HDF5
        model.save_weights("/content/drive/My Drive/Colab Notebooks/model/model.h5")
